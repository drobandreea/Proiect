...
<div class="container">
 ...
 <a href="{{ url('cart') }}" class="btn btn-warning"><i class="fa fa-shopping-cart"></i> Cos</a></td>
 </button>
 ...
 <p>{{ $details['nume'] }}</p>
<span class="pret text-info"> Lei {{ $details['pret'] }}</span> <span class="count"> Cantitate:{{ $details['cantitate'] }}</span>
 </div>
 </div>
 @endforeach
 @endif
